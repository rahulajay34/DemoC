    ...
    <div className="min-h-screen p-6 space-y-8">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        >
          ...
          <option value="active" style={{ color: '#111827', backgroundColor: 'white' }}>Active</option>
          <option value="moving" style={{ color: '#111827', backgroundColor: 'white' }}>Moving</option>
          <option value="parked" style={{ color: '#111827', backgroundColor: 'white' }}>Parked</option>
          <option value="idle" style={{ color: '#111827', backgroundColor: 'white' }}>Idle</option>
        </select>
